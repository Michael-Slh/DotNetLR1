...
namespace Data
{
    static public class DataSeeding
    {
        ...
        {
            // companies
            var comp1 = new Company { Id = Guid.NewGuid(), Name = "Regabus" };
            var comp2 = new Company { Id = Guid.NewGuid(), Name = "RAZVOZKA" };
            var comp3 = new Company { Id = Guid.NewGuid(), Name = "KYIV BUS" };
            var comp4 = new Company { Id = Guid.NewGuid(), Name = "Seven Cars" };
            ...
            var bus1 = new Bus
            {
                Id = Guid.NewGuid(),
                Number = "AC 1234 AA",
                Routes = new List<Course> { route1, route5, route6 }
            };
            ...
            return new Assets { Companies = companies, Buses = buses, BusCourses = busRoutes, Routes = routes };
        }
    }
}
